 <div id="lightbox_invite_html_holder">
    ...
    <div style="margin-top: 25px;text-align: right;">
        <img src="/img/ajax-loader.gif" style="height: 20px;margin-right: 10px;display: none;" id="delete_invitation_lightbox_loader">
        <a href="javascript:void(0);" id="delete_invitation_a_btn">Delete invitation</a>
        <button class="btn_1"
...
<script>
    $("#delete_invitation_a_btn").click(function(){
        $("#delete_invitation_lightbox_loader").show();
        $.post("/teams/invite/delete", {"invitation_id": '{{ $invitation->id }}' }).done(function(data){
            if(data.trim() == "success"){
                html  = '<div style="padding: 25px;text-align: center;font-size: 18px;">';
                html += 'You successfully deleted the invitation.';
                html += '</div>';
            } else {
                html = 'Unknown error ... Please try again later.';
            }
            $("#lightbox_invite_html_holder").html(html);
        });
    });
</script>